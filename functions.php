...
function beonepage_scripts() {
	...
	wp_enqueue_style( 'beonepage-animate-style', get_template_directory_uri() . '/layouts/animate.css', array() );
	...
	wp_enqueue_script('beonepage-wow-js',  get_template_directory_uri() .'/js/wow.min.js', array(''),  true);	
	wp_enqueue_script('beonepage-main-js',  get_template_directory_uri() .'/js/main.js', array(''),  true);	
	wp_enqueue_script('beonepage-owl-carousel-js',  get_template_directory_uri() .'/js/owl.carousel.min.js', array(''),  true);
